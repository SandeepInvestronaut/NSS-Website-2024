...
const programs = [
    ...
    },
    {
        ...
        subtitle: 'The ‘Plastic waste management’ was a ground-breaking initiative aimed...',
        Rmore: 'Read More'
    },
    ...
    return `
        <div class="item">
            <div class="card_one">
                ...
                <div class="calender">
                    <span><img src="${program.Ciocn}" alt />${program.Cicon_text}</span>
                </div>
                <div class="location">
                    <span><img src="${program.Licon}" alt />${program.Licon_text}</span>
                </div>
                <p class="card_one_text">${program.title}</p>
                <p class="card_one_two">
                    ${program.subtitle.split('...')[0]}
                    <span class="extra-text hidden">${program.subtitle.split('...')[1]}</span>
                </p>
